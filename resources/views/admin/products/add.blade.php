...
@section('content')
    <div class="clearfix">
        <div class="body mt-4">
            ...
            @include('admin.alert')
            <form class="ml-4" method="post" enctype="multipart/form-data" action="/dashboard/products/store">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4 mt-2">
                        <input type="number" name="price_sale" class="form-control" placeholder="Giá Sale">
                    </div>
                    <div class="col-sm-4 mt-2">
                        <input type="number" name="quantity" class="form-control" placeholder="Số lượng sản phẩm có">
                    </div>
                </div>
                ...
                <div class="mb-4">
                    <input checked value="1" style="margin-top: 5px; margin-left: 12px;" name="status" type="radio">
                    <label for="active">
                        Public
                    </label>
                ...
                <div class="mb-4">
                    <input value="0" style="margin-top: 5px; margin-left: 12px;" name="status" type="radio">
                    <label>
                        Private
                    </label>
                </div>
